  ...
  const { data: conversation } = useQuery({
    ...
    queryFn: async () => {
      ...
      const welcomeMsg = hotel
        ...
        : `Welcome to Get OS! I'm your AI concierge. How may I assist you today? I can help with menu recommendations, reservations, order tracking, and more.`;
  ...
  const clearConversationMutation = useMutation({
    mutationFn: async () => {
      ...
      const welcomeMsg = hotel
        ...
        : `Welcome to Get OS! I'm your AI concierge. How may I assist you today?`;
      const newConv = await base44.entities.ChatConversation.create({
        user_identifier: convKey,
        messages: [{
          role: 'assistant',
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const hotelContext = hotel
        ...
        : `You are an AI assistant for Get OS, a luxury seven-star restaurant.`;
            ...
            <div className="flex items-center justify-between p-4 border-b border-[#c9a962]/20">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-inter text-xs text-[#c9a962]">{hotel ? hotel.name : 'Get OS'}</p>
                </div>
              </div>
