...
export default function WhatsAppNotifier({ order, status = 'confirmed', label, size = 'sm', staffPhone = null }) {
  ...
  const handleClick = () => {
    const message = encodeURIComponent(buildOrderMessage(order, status));
